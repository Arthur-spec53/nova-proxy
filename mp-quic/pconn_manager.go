...
func (pcm *PconnManager) SetAsClient() {
	pcm.Perspective = protocol.PerspectiveClient
}

func (pcm *PconnManager) SetAsServer() {
	pcm.Perspective = protocol.PerspectiveServer
}
